...
/*  This struct contains the configuration of the stabilizer. It has the weight variables for the Q, R, and W matrices, 
    ...
    struct configuration {
        ...
        Vector3d qcom_p {1e6, 1e6, 1e6};
        Vector3d qcom_R {3e4, 3e4, 3e4};
        Vector3d qcom_vel {3e2, 3e2, 3e2};
        Vector3d qcom_angvel {3e3, 3e3, 3e3};

        Vector3d qRF_p {3e6, 3e6, 3e6};
        Vector3d qRF_R {1e5, 1e5, 1e5};
        Vector3d qRF_vel {1e5, 1e5, 1e5};
        Vector3d qRF_angvel {1e4, 1e4, 1e4};

        Vector3d qLF_p {3e6, 3e6, 3e6};
        Vector3d qLF_R {1e5, 1e5, 1e5};
        Vector3d qLF_vel {1e5, 1e5, 1e5};
        Vector3d qLF_angvel {1e4, 1e4, 1e4};
        ...
        Vector3d wt_RF {0.8, 0.8, 0.8};
        Vector3d wf_LF {0.8, 0.8, 0.8};
        Vector3d wt_LF {0.8, 0.8, 0.8};
