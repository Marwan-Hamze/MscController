...
/*  This struct contains the configuration of the stabilizer. It has the weight variables for the Q, R, and W matrices, 
    ...
    struct configuration {
        ...
        Vector3d qcom_p {3e8, 3e8, 3e8}; //For rigid floor: {1e10, 1e10, 1e10}. For compliant floor: {1e6, 1e6, 1e6}
        Vector3d qcom_R {1e4, 1e4, 1e4}; //For rigid floor: {1e9, 1e9, 1e9}. For compliant floor: {3e4, 3e4, 3e4}
        Vector3d qcom_vel {1e5, 1e5, 1e5}; //For rigid floor: {3e8, 3e8, 3e8}. For compliant floor: {3e2, 3e2, 3e2}
        Vector3d qcom_angvel {1e3, 1e3, 1e3}; //For rigid floor: {3e6, 3e6, 3e6}. For compliant floor: {3e3, 3e3, 3e3}

        Vector3d qRF_p {1e9, 1e9, 1e9}; //For rigid floor: {3e11, 3e11, 3e11}. For compliant floor: {3e6, 3e6, 3e6}
        Vector3d qRF_R {3e6, 3e6, 3e6}; //For rigid floor: {3e7, 3e7, 3e7}. For compliant floor: {1e5, 1e5, 1e5}
        Vector3d qRF_vel {3e6, 3e6, 3e6}; //For rigid floor: {1e9, 1e9, 1e9}. For compliant floor: {1e5, 1e5, 1e5}
        Vector3d qRF_angvel {1e4, 1e4, 1e4}; //For rigid floor: {3e8, 3e8, 3e8}. For compliant floor: {1e4, 1e4, 1e4}

        Vector3d qLF_p {1e9, 1e9, 1e9}; //For rigid floor: {3e11, 3e11, 3e11}. For compliant floor: {3e6, 3e6, 3e6}
        Vector3d qLF_R {3e6, 3e6, 3e6}; //For rigid floor: {3e7, 3e7, 3e7}. For compliant floor: {1e5, 1e5, 1e5}
        Vector3d qLF_vel {3e6, 3e6, 3e6}; //For rigid floor: {1e9, 1e9, 1e9}. For compliant floor: {1e5, 1e5, 1e5}
        Vector3d qLF_angvel {1e4, 1e4, 1e4}; //For rigid floor: {3e8, 3e8, 3e8}. For compliant floor: {1e4, 1e4, 1e4}
        ...
        Vector3d wf_RF {0.98, 0.98, 0.98}; //For rigid floor: {0.95, 0.95, 0.95}. For compliant floor: {0.8, 0.8, 0.8}
        Vector3d wt_RF {0.98, 0.98, 0.98}; //For rigid floor: {0.95, 0.95, 0.95}. For compliant floor: {0.8, 0.8, 0.8}
        Vector3d wf_LF {0.98, 0.98, 0.98}; //For rigid floor: {0.95, 0.95, 0.95}. For compliant floor: {0.8, 0.8, 0.8}
        Vector3d wt_LF {0.98, 0.98, 0.98}; //For rigid floor: {0.95, 0.95, 0.95}. For compliant floor: {0.8, 0.8, 0.8}
